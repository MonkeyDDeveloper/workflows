...
namespace PortfolioBackend.Migrations
{
    ...
    [Migration("20241218171326_add_python_cli_project")]
    partial class add_python_cli_project
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioBackend.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            LogoPath = "/experience/dacodes_logo.webp",
                            Name = "Dacodes"
                        },
                        new
                        {
                            Id = 2,
                            LogoPath = "/experience/nomina360.png",
                            Name = "Soluciones y Proyectos SA"
                        },
                        new
                        {
                            Id = 3,
                            LogoPath = "/experience/cacao_logo.jpg",
                            Name = "Cacao Web Studio"
                        },
                        new
                        {
                            Id = 1,
                            LogoPath = "/experience/monkey_d_developer.png",
                            Name = "MonkeyDDeveloper"
                        });
                });

            modelBuilder.Entity("PortfolioBackend.Models.CompanyExperience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("company_experiences", (string)null);
            ...
            modelBuilder.Entity("PortfolioBackend.Models.Project", b =>
                {
                    ...
                    b.Property<string>("GithubUri")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("github_uri");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            Description = "CRUD with Python using Psycopg2, Docker, Postgres SQL Scripts, Bcrypt, PrettyTable and email-validator",
                            GithubUri = "https://github.com/MonkeyDDeveloper/python_console_crud",
                            Name = "Python CLI CRUD with Postgres"
                        });
                });
            ...
            modelBuilder.Entity("PortfolioBackend.Models.CompanyExperience", b =>
                {
                    b.HasOne("PortfolioBackend.Models.Company", "Company")
                        .WithMany()
                    ...
                    b.HasOne("PortfolioBackend.Models.ProfessionalExperience", "ProfessionalExperience")
                        .WithOne("CompanyExperience")
                        .HasForeignKey("PortfolioBackend.Models.CompanyExperience", "ExperienceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PortfolioBackend.Models.ProfessionalExperience", b =>
                {
                    b.Navigation("CompanyExperience")
                        .IsRequired();
